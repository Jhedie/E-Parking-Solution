...
12. Car Parking Finder App UI Clone in React Native #2: Scrolling/Swiping Transition:
...
14. Fast 2kB alternative to Moment.js with the same modern API
    https://day.js.org/
...
19. Firebase Environment Configuration:
...
23. React native Animations:
    Interpolation:
    https://youtu.be/ybcL8e6ImSo

24. Custom Animated Markers and Region Focus when Content is Scrolled in React Native:
    https://youtu.be/sueqYRRarso

25. Handling multiple dates logic:
...
26. How to send emails using Python Django and Google SMTP server at no cost.
...
29. How to set up node typescript express
    https://blog.logrocket.com/how-to-set-up-node-typescript-express/

30. Adding SVG,PNGS etc
    https://stackoverflow.com/questions/7109924/cannot-find-module-file-name-png-or-its-corresponding-type-declarations-type

31. Boiler plate for node typescript express REST API
...
33. Ensuring Verification security:
...
46. Firebase Admin CMS
    Firecms

https://github.com/resulturan/refine-firebase

43. Create custom AutoComplete component:
