        ...
        return (
          <div>
            ...
            <div className="card bg-white shadow-xl p-4 flex mt-4">
              ...
              <button
                className="btn w-fit mt-2 bg-red-300 hover:bg-red-500"
                onClick={() => {
                  if (parkingLot.values.Status === "Inactive") {
                    ...
                    toast.error(
                      "This is an active parking lot. Please request deactivate first"
                    );
                  }
                }}
              >
