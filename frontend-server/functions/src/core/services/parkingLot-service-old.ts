...
//   async createSubParkingLot(testData: {
//     name: string;
//     description: string;
//     latitude: number;
//     longitude: number;
...
//     owner: string;
//   }): Promise<any> {
//     //Add parkinglot as subcollection to the owner document
//     const db = admin.firestore();
//     const ownerRef = db.collection("users").doc(testData.owner);
//     const subParkingLotRef = ownerRef.collection("subParkingLots").doc();
//     const subParkingLotData = {
//       name: testData.name,
...
//       ),
//     };
//     await subParkingLotRef.set(subParkingLotData);
//     return subParkingLotData;
//   }
